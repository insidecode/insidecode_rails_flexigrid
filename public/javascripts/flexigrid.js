 ...
 *
 * Connectionyright (c) 2008 Paulo P. Marinas (webplicity.net/flexigrid)
...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 title: false,
			 pagestat: 'Exibindo de {from} até {to} do total de {total} registros',
			 pagetext: 'Pág.',
			 outof: 'de',
			 findtext: 'Procurar: ',
			 procmsg: 'Carregando, por favor aguarde ...',
			 query: '',
			 qtype: '',
			 qop: '',
		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>"+p.findtext+"&nbsp;&nbsp;<select name='qtype'>"+sopt+"</select>&nbsp;&nbsp;<select name='qop'>" + oopt + "</select>&nbsp;&nbsp;<input type='text' size='30' name='q' class='qsbox' /> <!--input type='button' value='Clear' /--> </div>");
		...
		if (p.title)
		{
			...
			if (p.showTableToggleBtn)
				{
					$(g.mDiv).append('<div class="ptogtitle" title="Minimizar/Maximizar Tabela"><span></span></div>');
